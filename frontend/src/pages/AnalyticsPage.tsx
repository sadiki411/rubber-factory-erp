    ...
    <div className="page-container analytics-page">
      ...
      <Card className="analytics-tabs-card data-card">
        <Tabs items={[
          ...
          { key: 'orders', label: '订单联动', children: <div className="analytics-tab-content"><Alert className="analytics-alert" type="info" showIcon title="按相同订单号汇总" description="生产与品检出货记录通过订单号文本匹配汇总；请确保两边填写完全相同的订单号。" /><Card styles={{ body: { padding: 0 } }}><Table rowKey="order_no" dataSource={data?.order_performance || []} columns={orderColumns} scroll={{ x: 1250 }} pagination={{ pageSize: 15 }} /></Card></div> },
