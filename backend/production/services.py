...
def resume_production_run(
    ...
    *,
    ...
    resumed = ProductionRun(
        ...
        large_strip_weight_g=run.large_strip_weight_g,
        large_strip_count=run.large_strip_count,
        small_strip_weight_g=run.small_strip_weight_g,
        small_strip_count=run.small_strip_count,
